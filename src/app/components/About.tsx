...
function About() {
  ...
  <div className="container m-0 p-0 py-10 mx-auto">
    <div className="flex flex-wrap w-full mb-18">
      ...
      <p className="lg:w-1/2 w-full text-bold text-black">We are passionate about delivering the freshest organic fruits and vegetables,since 2002 grown sustainably and free from harmful chemicals. Our mission is to promote healthy living while protecting the environment, offering you nutritious, farm-fresh produce that’s good for you and the planet. Now afetr the success of our product introducing a organic seeds for sale for the betterment of our earth eco-friendly and healthy.</p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="p-6 rounded-lg transition-transform duration-200 ease-in-out transform hover:scale-110">
          ...
          <p className="text-base">We prioritize using clean, high-quality water to nourish our crops, ensuring they grow naturally and free from harmful pesticides. By embracing organic farming methods, we protect both the environment and your health, delivering produce that's as pure as nature intended.</p>
        </div>
      </div>
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="p-6 rounded-lg transition-transform duration-200 ease-in-out transform hover:scale-110">
