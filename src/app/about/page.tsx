      ...
      <section className="bg-green-100 min-h-screen">
        <div className="container px-5 py-10 mx-auto">
          ...
          <p className="text-black text-xl text-center pt-0 mb-5">
            ...
            nurtured by nature is own rhythms. Every seed we plant is a promise
            ...
            <div className="p-4 lg:w-1/3">
              <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                ...
                <p className="text-gray-600 mb-10 pt-3">
                  ...
                  packed with nature is goodness.Handpicked at the peak of
            ...
            <div className="p-4 lg:w-1/3">
              <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                ...
                <p className="text-gray-600 mb-10 pt-3">
                  ...
                  sustainable farming practices that preserve the earth is
            ...
            <div className="p-4 lg:w-1/3">
              <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                ...
                <p className="text-gray-600 mb-10 pt-3">
                  ...
                  GMOs. Whether you are planting for fresh herbs vegetables or
